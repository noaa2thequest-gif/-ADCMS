(function(root, factory) {
  ...
  const defaultUsers = [
    ...
    { email: 'eng@adcms.com', password: '123', name: 'Maintenance Engineer', role: 'engineer', approved: true },
    { email: 'cabin@adcms.com', password: '123', name: 'Cabin Department', role: 'cabin', approved: true },
    { email: 'auditor@adcms.com', password: '123', name: 'Quality Auditor', role: 'auditor', approved: true },
    { email: 'warehouse@adcms.com', password: '123', name: 'Store Keeper', role: 'warehouse', approved: true },
    { email: 'supervisor@adcms.com', password: '123', name: 'Maintenance Supervisor', role: 'engineer', approved: true },
    { email: 'tech1@adcms.com', password: '123', name: 'Technician 1', role: 'engineer', approved: false },
    { email: 'tech2@adcms.com', password: '123', name: 'Technician 2', role: 'cabin', approved: false },
    { email: 'user10@adcms.com', password: '123', name: 'Operations Staff', role: 'warehouse', approved: false }
  ];
